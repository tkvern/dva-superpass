              ...
              <div className={`${style.formItem} ${style.antRow}`}>
                ...
                <Input.Group>
                  ...
                  {getFieldDecorator('large_fluctuation_detection_time', {
                    ...
                    <Input size="large" type="number" addonAfter="分钟内波动超过" style={{ width: '55%' }} placeholder="0" />
                  )}
                  {getFieldDecorator('large_fluctuation_detection_percent', {
                    ...
                    <Input size="large" type="number" addonAfter="% 提醒" style={{ width: '45%' }} placeholder="0.00" />
                  )}
                </Input.Group>
                <div>
